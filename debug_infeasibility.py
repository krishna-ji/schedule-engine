...
from src.ga.core.population import create_smart_individual, get_family_map_from_json
...
ind = create_smart_individual(ctx, family_map, seed=42)
...
if violations:
    ...
    if not result.success:
        ...
        instructors_needed = set(g.instructor_id for g in violated_genes)
        rooms_needed = set(g.room_id for g in violated_genes)
        groups_affected = set()
