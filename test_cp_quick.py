...
print(f"  CP quick: {result['results']['cp_quick_repairs']} ({result['results']['cp_quick_success']} ok)")
print(f"  CP full:  {result['results']['cp_full_repairs']} ({result['results']['cp_full_success']} ok)")
print("="*60)
