...
class TestGroupConflicts:
    ...
    def test_simple_group_conflict(self):
        ...
        genes = [
            create_test_gene(course_id="CS101", group_ids=["G1"], start_quanta=0, num_quanta=3),
            create_test_gene(course_id="CS102", group_ids=["G1"], start_quanta=0, num_quanta=3),
        ]
    ...
    def test_partial_overlap(self):
        ...
        genes = [
            create_test_gene(course_id="CS101", group_ids=["G1"], start_quanta=0, num_quanta=5),
            create_test_gene(course_id="CS102", group_ids=["G1"], start_quanta=3, num_quanta=5),
        ]
...
class TestUtilityMethods:
    ...
    def test_get_all_violated_indices(self):
        ...
        genes = [
            ...
            create_test_gene(group_ids=["G1"], room_id="R101", start_quanta=0),
            create_test_gene(group_ids=["G2"], room_id="R102", start_quanta=10),  # No conflict
        ]
