...
Phase 4 of the OOP redesign. Provides a single class that:
...
This facade does NOT rewrite the 6,000 lines of repair logic — it
composes the existing ``RepairOperator`` implementations behind a clean
API that the scheduler (and future EvolutionEngine) can call.

Usage::

    from schedule_engine.operators.repair_pipeline import RepairPipeline
