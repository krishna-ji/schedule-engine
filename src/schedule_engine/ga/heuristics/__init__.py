...
Usage (OOP):
    from schedule_engine.ga.heuristics import ALL_HEURISTICS, build_heuristics
...
Usage (Legacy):
    from schedule_engine.ga.heuristics import get_all_heuristics, get_enabled_heuristics
...
from schedule_engine.ga.heuristics.all_heuristics import (
    CATEGORIES,
    HeuristicInfo,
    get_all_heuristics,
