...
from schedule_engine.ga.evaluator.gpu_batch_evaluator import get_gpu_evaluator
...
class HybridEvaluator:
    ...
    def __init__(
        ...
        from schedule_engine.ga.evaluator.gpu_batch_evaluator import GPUConstraintEvaluator
