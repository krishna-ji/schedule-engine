...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        choices=profiles,
        help="Training profile defined in schedule_engine.rl.training.presets",
    )
...
def main() -> None:
    ...
    if args.list_profiles:
        ...
        if available:
            ...
            logger.warning(
                "No training profiles registered. Update schedule_engine.rl.training.presets to add more."
            )
        return
    ...
    try:
        ...
        if args.curriculum:
            ...
            from schedule_engine.rl.training.curriculum import (
                CurriculumManager,
