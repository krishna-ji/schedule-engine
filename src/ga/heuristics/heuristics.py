...
def _create_perturbation_heuristics(**params: Any) -> list[Heuristic]:
    ...
    from src.ga.heuristics.perturbation import (
        instructor_reassign,
        multi_perturbation,
        random_swap,
        room_shuffle,
...
def _create_improvement_heuristics(**params: Any) -> list[Heuristic]:
    ...
    from src.ga.heuristics.improvement import (
        ejection_chain,
        kempe_chain,
...
def _create_diversity_heuristics(**params: Any) -> list[Heuristic]:
    ...
    from src.ga.heuristics.diversity import (
...
def _create_meta_heuristics(**params: Any) -> list[Heuristic]:
    ...
    from src.ga.heuristics.meta import (
