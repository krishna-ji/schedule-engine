...
from src.ga.heuristics.parallel_executor import (
    ParallelHeuristicExecutor,
    get_parallel_executor,
)
from src.ga.metrics.diversity import average_pairwise_diversity
...
class GAScheduler:
    ...
    def _evolve_generation(self, gen: int, progress=None):
        ...
        from src.utils.logging_config import EventTracker
