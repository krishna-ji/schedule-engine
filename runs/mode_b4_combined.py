...
def main() -> None:
    ...
    plot_convergence(
        stats, OUTPUT_DIR / "mode_b4_convergence.png", title_prefix="Mode B4: "
    )
    logger.info(f"Saved: {OUTPUT_DIR / 'mode_b4_convergence.png'}")

    plot_constraint_breakdown(
        breakdown,
        OUTPUT_DIR / "mode_b4_breakdown.png",
        title="Mode B4: Constraint Violations",
    )
    logger.info(f"Saved: {OUTPUT_DIR / 'mode_b4_breakdown.png'}")
