#!/usr/bin/env python3
"""
RL Train DQN: Deep Q-Network Agent

Train DQN agent on ScheduleEnv for repair heuristic selection.
Comparison against PPO baseline.
...
def setup_logging(output_dir: Path) -> logging.Logger:
    ...
    log_file = output_dir / "rl_02_train_dqn.log"
    ...
    logger = logging.getLogger("rl_02_train_dqn")
...
def main() -> None:
    ...
    OUTPUT_DIR = PROJECT_ROOT / "output" / "rl_02_train_dqn" / TIMESTAMP
