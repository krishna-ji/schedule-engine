...
def setup_logging(output_dir: Path) -> logging.Logger:
    ...
    log_file = output_dir / "mode_b3_two_phase.log"
    ...
    logger = logging.getLogger("mode_b3_two_phase")
...
def main() -> None:
    ...
    OUTPUT_DIR = PROJECT_ROOT / "output" / "mode_b3_two_phase" / TIMESTAMP
    ...
    logger.info(f"Phase 1 repairs: {phase1_repairs}")
    logger.info(f"Phase 2 repairs: {phase2_repairs}")
    ...
    plot_convergence(
        stats, OUTPUT_DIR / "mode_b3_convergence.png", title_prefix="Mode B3: "
    )
    logger.info(f"Saved: {OUTPUT_DIR / 'mode_b3_convergence.png'}")

    plot_constraint_breakdown(
        breakdown,
        OUTPUT_DIR / "mode_b3_breakdown.png",
        title="Mode B3: Constraint Violations",
    )
    logger.info(f"Saved: {OUTPUT_DIR / 'mode_b3_breakdown.png'}")
    ...
    metadata = {
        ...
        "config": {
            ...
            "phase1_repair_prob": PHASE1_REPAIR_PROB,
        ...
        "results": {
            ...
            "phase1_repairs": phase1_repairs,
            "phase2_repairs": phase2_repairs,
