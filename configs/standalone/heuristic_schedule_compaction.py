"""
Heuristic Test: schedule_compaction (Repair)

Standalone configuration for isolated schedule_compaction testing.
...
@dataclass
class ScheduleCompactionConfig:
    """Schedule compaction heuristic test config."""

    # === METADATA ===
    name: str = "heuristic-schedule-compaction"
    experiment_id: str = "F-REPAIR-06"
    environment: str = "test"
    notes: str = "Isolated test: schedule_compaction"
    ...
    # === HEURISTIC TOGGLES (Only schedule_compaction ON) ===
    ...
    heuristic_schedule_compaction: bool = True
...
def get_test_config() -> ScheduleCompactionConfig:
    """Get test profile config (30 gens, 10 pop)."""
    return ScheduleCompactionConfig(ngen=30, pop_size=10, environment="test")


def get_prod_config() -> ScheduleCompactionConfig:
    """Get production profile config (2000 gens, 200 pop)."""
    return ScheduleCompactionConfig(ngen=2000, pop_size=200, environment="prod")
