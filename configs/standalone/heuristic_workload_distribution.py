"""
Heuristic Test: workload_distribution (Repair)

Standalone configuration for isolated workload_distribution testing.
...
class WorkloadDistributionConfig:
    """Workload distribution heuristic test config."""

    # === METADATA ===
    name: str = "heuristic-workload-distribution"
    experiment_id: str = "F-REPAIR-05"
    environment: str = "test"
    notes: str = "Isolated test: workload_distribution"
    ...
    # === HEURISTIC TOGGLES (Only workload_distribution ON) ===
    ...
    heuristic_workload_distribution: bool = True
...
def get_test_config() -> WorkloadDistributionConfig:
    """Get test profile config (30 gens, 10 pop)."""
    return WorkloadDistributionConfig(ngen=30, pop_size=10, environment="test")


def get_prod_config() -> WorkloadDistributionConfig:
    """Get production profile config (2000 gens, 200 pop)."""
    return WorkloadDistributionConfig(ngen=2000, pop_size=200, environment="prod")
