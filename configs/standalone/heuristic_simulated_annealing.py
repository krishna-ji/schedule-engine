"""
Heuristic Test: simulated_annealing (Improvement)

Standalone configuration for isolated simulated_annealing testing.
...
class SimulatedAnnealingConfig:
    """Simulated annealing heuristic test config."""

    # === METADATA ===
    name: str = "heuristic-simulated-annealing"
    experiment_id: str = "F-IMPROVE-03"
    environment: str = "test"
    notes: str = "Isolated test: simulated_annealing"
    ...
    # === HEURISTIC TOGGLES (Only simulated_annealing ON) ===
    ...
    heuristic_simulated_annealing: bool = True
...
def get_test_config() -> SimulatedAnnealingConfig:
    """Get test profile config (30 gens, 10 pop)."""
    return SimulatedAnnealingConfig(ngen=30, pop_size=10, environment="test")


def get_prod_config() -> SimulatedAnnealingConfig:
    """Get production profile config (2000 gens, 200 pop)."""
    return SimulatedAnnealingConfig(ngen=2000, pop_size=200, environment="prod")
