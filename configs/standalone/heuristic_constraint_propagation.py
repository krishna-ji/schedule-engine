"""
Heuristic Test: constraint_propagation (Repair)

Standalone configuration for isolated constraint_propagation testing.
...
@dataclass
class ConstraintPropagationConfig:
    """Constraint propagation heuristic test config."""

    # === METADATA ===
    name: str = "heuristic-constraint-propagation"
    experiment_id: str = "F-REPAIR-03"
    environment: str = "test"
    notes: str = "Isolated test: constraint_propagation"
    ...
    # === HEURISTIC TOGGLES (Only constraint_propagation ON) ===
    ...
    heuristic_constraint_propagation: bool = True
...
def get_test_config() -> ConstraintPropagationConfig:
    """Get test profile config (30 gens, 10 pop)."""
    return ConstraintPropagationConfig(ngen=30, pop_size=10, environment="test")


def get_prod_config() -> ConstraintPropagationConfig:
    """Get production profile config (2000 gens, 200 pop)."""
    return ConstraintPropagationConfig(ngen=2000, pop_size=200, environment="prod")
