"""
Heuristic Test: crossover_repair (Repair)

Standalone configuration for isolated crossover_repair testing.
...
@dataclass
class CrossoverRepairConfig:
    """Crossover repair heuristic test config."""

    # === METADATA ===
    name: str = "heuristic-crossover-repair"
    experiment_id: str = "F-REPAIR-07"
    environment: str = "test"
    notes: str = "Isolated test: crossover_repair"
    ...
    # === HEURISTIC TOGGLES (Only crossover_repair ON) ===
    ...
    heuristic_crossover_repair: bool = True
...
def get_test_config() -> CrossoverRepairConfig:
    """Get test profile config (30 gens, 10 pop)."""
    return CrossoverRepairConfig(ngen=30, pop_size=10, environment="test")


def get_prod_config() -> CrossoverRepairConfig:
    """Get production profile config (2000 gens, 200 pop)."""
    return CrossoverRepairConfig(ngen=2000, pop_size=200, environment="prod")
