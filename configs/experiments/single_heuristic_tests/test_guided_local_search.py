...
class SingleHeuristicTestConfig(TestConfig):
    name: str = "test-guided-local-search"
    experiment_id: str = "F"
    output_subdir: str = "f-meta"  # Category-specific output folder
    heuristics_master_enabled: bool = True
    repair_enabled: bool = False

    # ENABLED: guided_local_search
    heuristic_guided_local_search: bool = True
    ...
    notes: str = "Testing guided_local_search only"
