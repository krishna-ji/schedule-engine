"""Test: variable_neighborhood_descent (Meta)"""
...
class SingleHeuristicTestConfig(TestConfig):
    name: str = "test-variable-neighborhood-descent"
    experiment_id: str = "F"
    output_subdir: str = "f-meta"  # Category-specific output folder
    heuristics_master_enabled: bool = True
    repair_enabled: bool = False

    # ENABLED: variable_neighborhood_descent
    heuristic_variable_neighborhood_descent: bool = True
    ...
    notes: str = "Testing variable_neighborhood_descent only"
