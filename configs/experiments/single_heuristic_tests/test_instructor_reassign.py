"""Test: instructor_reassign (Perturbation)"""
...
class SingleHeuristicTestConfig(TestConfig):
    name: str = "test-instructor-reassign"
    experiment_id: str = "F"
    output_subdir: str = "f-perturbation"  # Category-specific output folder
    heuristics_master_enabled: bool = True
    repair_enabled: bool = False

    # ENABLED: instructor_reassign
    heuristic_instructor_reassign: bool = True
    ...
    notes: str = "Testing instructor_reassign only"
