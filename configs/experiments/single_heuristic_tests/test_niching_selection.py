"""Test: niching_selection (Diversity)"""
...
class SingleHeuristicTestConfig(TestConfig):
    name: str = "test-niching-selection"
    experiment_id: str = "F"
    heuristics_master_enabled: bool = True
    repair_enabled: bool = False

    # ENABLED: niching_selection
    heuristic_niching_selection: bool = True
    ...
    notes: str = "Testing niching_selection only"
