"""Test: crowding_mutation (Diversity)"""
...
class SingleHeuristicTestConfig(TestConfig):
    name: str = "test-crowding-mutation"
    experiment_id: str = "F"
    heuristics_master_enabled: bool = True
    repair_enabled: bool = False

    # ENABLED: crowding_mutation
    heuristic_crowding_mutation: bool = True
    ...
    notes: str = "Testing crowding_mutation only"
