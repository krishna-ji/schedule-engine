"""Test: variable_depth_search (Improvement)"""
...
class SingleHeuristicTestConfig(TestConfig):
    name: str = "test-variable-depth-search"
    experiment_id: str = "F"
    output_subdir: str = "f-improvement"  # Category-specific output folder
    heuristics_master_enabled: bool = True
    repair_enabled: bool = False

    # ENABLED: variable_depth_search
    heuristic_variable_depth_search: bool = True
    ...
    notes: str = "Testing variable_depth_search only"
