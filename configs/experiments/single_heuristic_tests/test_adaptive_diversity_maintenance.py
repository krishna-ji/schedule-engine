"""Test: adaptive_diversity_maintenance (Diversity)"""
...
class SingleHeuristicTestConfig(TestConfig):
    ...
    # ENABLED: adaptive_diversity_maintenance
    heuristic_adaptive_diversity_maintenance: bool = True
    ...
    notes: str = "Testing adaptive_diversity_maintenance only"
