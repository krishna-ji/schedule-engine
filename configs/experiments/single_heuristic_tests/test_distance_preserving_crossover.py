"""Test: distance_preserving_crossover (Diversity)"""
...
class SingleHeuristicTestConfig(TestConfig):
    name: str = "test-distance-preserving-crossover"
    experiment_id: str = "F"
    heuristics_master_enabled: bool = True
    repair_enabled: bool = False

    # ENABLED: distance_preserving_crossover
    heuristic_distance_preserving_crossover: bool = True
    ...
    notes: str = "Testing distance_preserving_crossover only"
