"""Test: earliest_deadline_first (Construction)"""
...
class SingleHeuristicTestConfig(TestConfig):
    name: str = "test-earliest-deadline-first"
    experiment_id: str = "F"
    heuristics_master_enabled: bool = True
    repair_enabled: bool = False

    # ENABLED: earliest_deadline_first
    heuristic_earliest_deadline_first: bool = True
    ...
    notes: str = "Testing earliest_deadline_first only"
