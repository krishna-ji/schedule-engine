"""Test: adaptive_large_neighborhood (Meta)"""
...
class SingleHeuristicTestConfig(TestConfig):
    name: str = "test-adaptive-large-neighborhood"
    experiment_id: str = "F"
    output_subdir: str = "f-meta"  # Category-specific output folder
    heuristics_master_enabled: bool = True
    repair_enabled: bool = False

    # ENABLED: adaptive_large_neighborhood
    heuristic_adaptive_large_neighborhood: bool = True
    ...
    notes: str = "Testing adaptive_large_neighborhood only"
