...
def test_conflict_detection_accuracy():
    ...
    genes = [
        ...
        SessionGene(
            ...
            course_type="theory",
            instructor_id="INST_002",
            group_ids=["GROUP_A"],  # Same group
            room_id="R102",
            start_quanta=0,
            num_quanta=2,  # Same time
        ),
    ]
    ...
    genes = [
        ...
        SessionGene(
            ...
            course_type="theory",
            instructor_id="INST_001",
            group_ids=["GROUP_B"],  # Same instructor
            room_id="R102",
            start_quanta=1,
            num_quanta=2,  # Overlapping time
        ),
    ]
    ...
    genes = [
        ...
        SessionGene(
            ...
            room_id="R101",
            start_quanta=0,
            num_quanta=2,  # Same room, same time
        ),
    ]
...
def test_caching_efficiency():
    ...
    genes = [
        SessionGene(
            ...
            course_type="theory",
            instructor_id=f"INST_{i % 5}",
            group_ids=[f"GROUP_{i}"],
            room_id=f"R{i}",
            start_quanta=i * 2,
            num_quanta=3,
        )
